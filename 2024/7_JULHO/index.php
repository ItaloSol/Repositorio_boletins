...
<main class="container">
  ...
  <a href="/../boletins/2024/7_JULHO/1_inserir_inserir.php" class="btn btn-warning rounded-pill px-3" type="button">Adicionar</a>
    <h6 class="border-bottom pb-2 mb-0">BOLETIM INTERNO</h6>
    <?php
$pasta = "../7_JULHO";  // Substitua pelo caminho real da sua pasta
