...
$pasta = "../boletins/";  // Substitua pelo caminho real da sua pasta
...
foreach ($itens as $item) {
    // Exclui os diretórios '.' e '..' (presentes em todos os diretórios)
    if ($item != "." && $item != "..") {
        // Verifica se o item é um diretório
        if (is_dir($pasta . '/' . $item)) {
          ?>
        <a href="<?= $item ?>/">  <div class="d-flex text-body-secondary pt-3">
